 ...
 * relating to, or arising from the internet telephony software of Skype Limited
 * (including its affiliates, "Skype"), including without limitation this source
 * code, Skype API and related material of such software proprietary to Skype
 * and/or its licensors ("IP Rights") are and shall remain the exclusive
 * property of Skype and/or its licensors. The recipient hereby acknowledges and
 * agrees that any unauthorized use of the IP Rights is a violation of
 * intellectual property laws.
 *
 * Skype reserves all rights and may take legal action against infringers of IP
 * Rights.
 *
 ...
 *
 * @author Andrea Drane (based on skype.javawrapper.client.JavaWrapperListeners
 * and ported/refactored from existing C++ tutorial code)
 *
 * @since 1.0
 */
public class Listeners implements
    ...
    /**
     * Initialized session instance providing access to this sessions's Skype
     * instance, Account instance, tutorial tag, and so forth
     *
     * @since 1.0
     */
    private MySession mySession;
    /**
     * Whether a call is in progress: Part I. <br /><br /> Holds a reference to
     * the affected Conversation instance so it doesn't get garbage-collected in
     * the middle of the call. Initialized to null by caller; set to non-null by
     * Conversation onPropertyChange and ConversationList onChange handlers.
     *
     * @see com.skype.api.Conversation
     * @see
     * com.skype.api.Skype.SkypeListener#OnConversationListChange(com.skype.api.Conversation,
     * com.skype.api.Conversation.LIST_TYPE, boolean)
     *
     * @since 1.0
     */
    Conversation activeConversation = null;
    /**
     * Whether a call is in progress: Part II. <br /><br /> Holds a reference to
     * <em>Participants</em> of the affected Conversation instance so they don't
     * get garbage-collected in the middle of the call. Initialized to null by
     * caller; set to non-null by Conversation onPropertyChange and
     * ConversationList onChange handlers.
     *
     * @see com.skype.api.Conversation
     * @see
     * com.skype.api.Skype.SkypeListener#OnConversationListChange(com.skype.api.Conversation,
    ...
    /**
     * Indicates whether OnApp2AppStreamListChange was ever fired with a
     * non-zero stream count. <br /> Basically, this is for "prettiness" - we'll
     * only display the "connection" message <em>once</em> per session.
     *
     * @since 1.0
     */
     ...
     *
     * @see
     * com.skype.api.Voicemail.VoicemailListener#OnPropertyChange(com.skype.api.SkypeObject,
     * com.skype.api.Voicemail.PROPERTY, java.lang.Object)
     */
     ...
     *
     * @see
     * com.skype.api.Video.VideoListener#OnCaptureRequestCompleted(com.skype.api.SkypeObject,
     * int, boolean, byte[], int, int)
     */
     ...
     *
     * @see
     * com.skype.api.Transfer.TransferListener#OnPropertyChange(com.skype.api.SkypeObject,
     * com.skype.api.Transfer.PROPERTY, java.lang.Object)
     */
    ...
    /**
     * ParticipantListener Override: Tutorial Handler - Sound Levels and Voice
     * Status. <ul> <li>Tutorial 5 - sound level property changes.</li>
     * <li>Tutorial 6/7 - voice status property changes.</li> </ul>
     *
     * @param obj The affected Participant.
     * @param prop The Participant property that triggered this event.
     * @param value Ignored.
     *
     * @since 1.0
     *
     * @see
     * com.skype.api.Participant.ParticipantListener#OnPropertyChange(com.skype.api.SkypeObject,
     * com.skype.api.Participant.PROPERTY, java.lang.Object)
     */
     ...
     *
     * @see
     * com.skype.api.Participant.ParticipantListener#OnIncomingDTMF(com.skype.api.SkypeObject,
     ...
     *
     * @see
     * com.skype.api.Message.MessageListener#OnPropertyChange(com.skype.api.SkypeObject,
     * com.skype.api.Message.PROPERTY, java.lang.Object)
     */
    public void OnPropertyChange(com.skype.api.SkypeObject obj, com.skype.api.Message.PROPERTY prop, Object value) {
    }

    /**
     * ConversationListener Override: Tutorial Handler - Conversation "Live
     * Status". <br /><br /> If it's <em>not</em> a "live status" change, ignore
     * it. Otherwise: <ul> <li>display changes to our live status</li>
     * <li>handle answering calls for us</li> </ul>
     *
     * Tutorial 6/7 - Looks for: <ul> <li>RINGING_FOR_ME so we can pick up the
     * call</li> <li>IM_LIVE to indicate that a call is in progress</li>
     * <li>RECENTLY_LIVE/NONE to indicate that a call has ended</li> </ul>
     *
     * @param obj The affected Conversation.
     * @param prop The Conversation property that triggered this event.
     * @param value Ignored.
     *
     * @since 1.0
     *
     * @see
     * com.skype.api.Conversation.ConversationListener#OnPropertyChange(com.skype.api.SkypeObject,
     * com.skype.api.Conversation.PROPERTY, java.lang.Object)
     */
     ...
     *
     * @see
     * com.skype.api.Conversation.ConversationListener#OnParticipantListChange(com.skype.api.SkypeObject)
     */
     ...
     *
     * @see
     * com.skype.api.Conversation.ConversationListener#OnMessage(com.skype.api.SkypeObject,
     ...
     *
     * @see
     * com.skype.api.Conversation.ConversationListener#OnSpawnConference(com.skype.api.SkypeObject,
     ...
     *
     * @see
     * com.skype.api.ContactSearch.ContactSearchListener#OnPropertyChange(com.skype.api.SkypeObject,
     * com.skype.api.ContactSearch.PROPERTY, java.lang.Object)
     */
     ...
     *
     * @see
     * com.skype.api.ContactSearch.ContactSearchListener#OnNewResult(com.skype.api.SkypeObject,
     * com.skype.api.Contact, int)
     */
     ...
     *
     * @see
     * com.skype.api.ContactGroup.ContactGroupListener#OnPropertyChange(com.skype.api.SkypeObject,
     * com.skype.api.ContactGroup.PROPERTY, java.lang.Object)
     */
     ...
     *
     * @see
     * com.skype.api.ContactGroup.ContactGroupListener#OnChangeConversation(com.skype.api.SkypeObject,
     * com.skype.api.Conversation)
     */
    ...
    /**
     * ContactGroupListener Override: Tutorial Handler - ContactGroup TYPE. <br
     * /><br /> This handler fires for all ContactGroups. If it's <em>not</em> a
     * pending authorization request, log and ignore it. <br /><br /> Tutorial 9
     * - Process authorization requests
     *
     * @since 1.0
     *
     * @see
     * com.skype.api.ContactGroup.ContactGroupListener#OnChange(com.skype.api.SkypeObject,
    ...
    public void OnChange(com.skype.api.SkypeObject obj, Contact contact) {
        ...
        /*
         * SetBuddyStatus should really return a boolean... If and when it does,
         * replace the above SetBuddyStatus invocation with the following... if
         * (contact.SetBuddyStatus(true, true)) {
         * MySession.myConsole.printf("%s: %s is now authorized%n",
         * mySession.myTutorialTag, contactSkypeName); } else {
         * MySession.myConsole.printf("%s: Authorization failed.%n",
    ...
    /**
     * ContactListener Override: Tutorial Handler - Availability. <br /><br />
     * Maps an availability property ENUM code to a text string, and writes that
     * string to the console. If it's <em>not</em> an availability change,
     * ignore it. <br /><br /> The implementation here follows the C++ pattern -
     * a switch statement with cases for each defined code. For Java 5.0, the
     * Enum class'
     * <code>toString</code> method eliminates the need for the entire switch
     * statement. For example, you could code the printf as:
     * <pre>
     *     MySession.myConsole.printf("%s: Availability of %s is now %s%n",
     *                       mySession.myTutorialTag,
     *                       affectedContact.GetStrProperty(Contact.PROPERTY.displayname),
     *                       availability.toString());
     * </pre> Implementing this functionality as a switch statement, however,
     * enables you to perform additional processing for specific cases.
     *
     * @param obj The affected Contact.
     * @param prop The Contact property that triggered this event.
     * @param value Ignored.
     *
     * @since 1.0
     *
     * @see
     * com.skype.api.Contact.ContactListener#OnPropertyChange(com.skype.api.SkypeObject,
     * com.skype.api.Contact.PROPERTY, java.lang.Object)
     */
     ...
     *
     * @see
     * com.skype.api.Skype.SkypeListener#OnNewCustomContactGroup(com.skype.api.ContactGroup)
     */
     ...
     *
     * @see
     * com.skype.api.Skype.SkypeListener#OnContactOnlineAppearance(com.skype.api.Contact)
     */
     ...
     *
     * @see
     * com.skype.api.Skype.SkypeListener#OnContactGoneOffline(com.skype.api.Contact)
     */
    public void OnContactGoneOffline(Contact contact) {
    }

    /**
     * SkypeListener Override: Tutorial Handler - Conversation LIST_TYPE. <br
     * /><br /> If it's <em>not</em> a LIVE_CONVERSATIONS change, ignore it; if
     * it's not a type we're interested in, simply write it to the console. <ul>
     * <li>Tutorial 5 - Looks for RINGING_FOR_ME so we can join in.</li>
     * <li>Tutorial 6 - Looks for IM_LIVE or RECENTLY_LIVE/NONE. Former case,
     * indicates that a call is in progress; latter case, indicates that a call
     * has ended.</li> </ul>
     *
     * @param conversation The affected Conversation.
     * @param type The Conversation list type that triggered this event.
     * @param added Ignored.
     *
     * @since 1.0
     *
    ...
    /**
     * SkypeListener Override: Tutorial Handler - Posted chat message. <br /><br
     * /> If it's <em>not</em> a POSTED_TEXT message, ignore it.
     *
     * @param message The affected Message.
     * @param changesInboxTimestamp Ignored.
     * @param supersedesHistoryMessage Ignored.
     * @param conversation The affected Conversation.
     *
     * @since 1.0
     *
    ...
    public void OnMessage(Message message,
            boolean changesInboxTimestamp, Message supersedesHistoryMessage, final Conversation conversation) {
        Message.TYPE msgType = Message.TYPE.get(message.GetIntProperty(Message.PROPERTY.type));

        if (msgType == Message.TYPE.POSTED_TEXT) {
            final String msgAuthor = message.GetStrProperty(Message.PROPERTY.author);
            final String msgBody = message.GetStrProperty(Message.PROPERTY.body_xml);
            if (!msgAuthor.equals(mySession.myAccountName)) {
                //my code
                        ...
                        Platform.runLater(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (chatframe == null) {
                                    ...
                                    chatframe.setSkype(conversation);
...
//            	conversation.PostText((targetDateFmt.format(targetDate.getTime()) + ": This is an automated reply"), false);
     ...
     * attempts direct connection to the network, then falls back to connection
     * via proxy.
     *
     * @since 1.0
     *
     * @see
     * com.skype.api.Skype.SkypeListener#OnProxyAuthFailure(Skype.PROXYTYPE)
     */
    ...
    /**
     * SkypeListener Override: Tutorial Handler - Datagrams. <br /><br /> In the
     * context of Tutorial 11 datagrams, this event fires when we receive a
     * datagram. Writes the name of the affected stream and the actual datagram
     * content to the console.
     *
     * @param appname The name of the application associated with this datagram
     * connection.
     * @param stream The name of the affected stream.
     * @param data The payload of this datagram.
     *
     * @since 1.0
     *
     * see com.skype.api.Skype.SkypeListener#OnApp2AppDatagram(java.lang.String,
    ...
    /*
     **
     * SkypeListener Override: Tutorial Handler - App2App Stream List. <br /><br
     * /> In the context of Tutorial 11 datagrams, this event fires when: <ol>
     * <li>Connection is established between two app2app applications. That is,
     * when both parties have an app up with the same name and <em>both</em>
     * used App2AppConnect In that case, both parties get this event, with
     * listType ALL_STREAMS</li> <li>When a datagram is sent, the sender will
     * get this event with listType SENDING_STREAMS Receiver of the datagram
     * will get OnApp2AppDatagram event instead.</li> <li>When the remote party
     * drops app2app connection, the local user will get
     * OnApp2AppStreamListChange with listType ALL_STREAMS and streams.length
     * zero, which is useful for detecting remote drops.</li> </ol>
     *
     * @param appname The name of the application associated with this datagram
     * connection. @param listType The type of the affected stream(s) - sending,
     * receiving, or "all" @param streams The names of the affected stream(s).
     * In the context of Tutorial 11 datagrams, we assume that there are only 2
     * participants and so th enumber of streams should be either 0 (zero;
     * remote shutdown) or 1 (one; initiated/datagram sent).
     *
     * @since 1.0
     *
     * @see
     * com.skype.api.Skype.SkypeListener#OnApp2AppStreamListChange(java.lang.String,
     * com.skype.api.Skype.APP2APP_STREAMS, java.lang.String[])
     *
     * public void OnApp2AppStreamListChange(String appname, APP2APP_STREAMS
     * listType, String[] streams) { int streamsCount = streams.length;
     *
     * if (streamsCount != 0) { // Normally the streamCount in this event should
     * be either 1 or 0. // More streams are possible when there are more than 2
     * connected // participants running the same application. For purposes of
     * this // example, we will assume that there are only 2 participants. int
     * i; for (i = 0; i < streamsCount; i++) {
     * MySession.myConsole.printf("OnApp2AppStreamListChange: %s %s %s%n",
     * mySession.mySkype.StreamListType(listType), appname, streams[i]);
     * mySession.mySkype.streamName = streams[i]; // We're assuming only one
     * stream! // If two or more, last one wins! }
     *
     * if (!appConnected) { appConnected = true; MySession.myConsole.printf("You
     * can now type and send datagrams to remote instance.%n"); } } else if
     * (listType == Skype.APP2APP_STREAMS.ALL_STREAMS) { // Remote side dropped
     * connection. MySession.myConsole.printf("No more app2app streams.%n");
     * mySession.mySkype.streamName = ""; } }
     */
    /**
     * AccountListener Override: Tutorial Handler - Account Properties. <br
     * /><br /> Status changes: Specifically looks for/handles login/logout
     * status changes, and reports those changes to the associated MySession
     * instance. Writes notice of <em>all</em> property changes to both the log
     * and the console. <br /><br /> Logout reasons: Writes reason for logout to
     * both the log and the console. Useful for differentiating explicit logout
     * by user (Account.LOGOUTREASON.LOGOUT_CALLED) and forced logout by the
     * SkypeKit runtime. <br /><br /> Other property changes: Writes the name of
     * the changed property to the console.
     *
     * @param obj Ignored - always assumes <em>our</em> account, so references
     * effected through
     * <code>mySession.myAccount</code>.
     * @param prop The Account property that triggered this event.
     * @param value Ignored.
     *
     * @since 1.0
     *
     * @see
     * com.skype.api.Account.AccountListener#OnPropertyChange(com.skype.api.SkypeObject,
     * com.skype.api.Account.PROPERTY, java.lang.Object)
     */
    ...
    /**
     * Business logic for answering a call (Tutorial_5 - Find conversation to
     * join). <br /><br /> Since this method is invoked from the Conversation
     * event handler
     * {@link #OnPropertyChange(com.skype.api.SkypeObject, com.skype.api.Conversation.PROPERTY, Object )},
     * it's most convenient to place it here in the Listeners class.
     *
     * @return <ul> <li>true: call picked up</li> <li>false: no call to pick
     * up/call not answered/error</li> </ul>
     *
     * @since 1.0
     */
