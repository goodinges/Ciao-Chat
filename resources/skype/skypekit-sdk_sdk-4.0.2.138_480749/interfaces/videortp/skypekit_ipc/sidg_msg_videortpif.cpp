...
Field Field::M_SkypeVideoRTPInterface_fields[] = {
    ...
    /*39*/ { { {&d2field_equals_default,&d2set_field_to_default,1,Sid::Field::FLD_FIRST,Sid::Field::KIND_INT, MsgGetStringPropertyRequest::END,0} } },    /*40*/ { { {&d2field_equals_default,&d2set_field_to_default,2,0,Sid::Field::KIND_INT, (unsigned short) (size_t) &reinterpret_cast<MsgGetStringPropertyRequest*>(base_address)->index,0} } },
    // request
    /*** MsgGetStringPropertyResponse */
    /*41*/ { { {&d1field_equals_default,&d1set_field_to_default,1,Sid::Field::FLD_FIRST,Sid::Field::KIND_BOOLEAN, MsgGetStringPropertyResponse::END,0} } },
    /*42*/ { { {&d6field_equals_default,&d6set_field_to_default,2,0,Sid::Field::KIND_STRING, (unsigned short) (size_t) &reinterpret_cast<MsgGetStringPropertyResponse*>(base_address)->value,0} } },
    // response
    //// SetStringProperty
    ...
    /*80*/ { { {&d1field_equals_default,&d1set_field_to_default,1,Sid::Field::FLD_FIRST,Sid::Field::KIND_BOOLEAN, MsgRequestRecoveryFrameResponse::END,0} } },    // response
    //// SetBitrate
    ...
    /*83*/ { { {&d2field_equals_default,&d2set_field_to_default,1,Sid::Field::FLD_FIRST,Sid::Field::KIND_INT, MsgSetFramerateRequest::END,0} } },
    // request
    /*** MsgSetFramerateResponse */
