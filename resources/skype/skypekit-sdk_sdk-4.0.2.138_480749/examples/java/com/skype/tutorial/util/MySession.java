...
import com.skype.tutorial.util.MySkype;
import com.skype.tutorial.util.ParseSkypeKitVersion;
 ...
 *	<li>{@link JavaTutorialListeners} instance (tutorials-specific "helper" class instance that
...
public class MySession {
	 ...
	 * 
	 * @see com.skype.tutorial.util.JavaTutorialListeners#OnPropertyChange(SkypeObject, com.skype.api.Conversation.PROPERTY, Object)
	 * @see com.skype.tutorial.util.JavaTutorialListeners#OnConversationListChange(com.skype.api.Conversation, com.skype.api.Conversation.LIST_TYPE, boolean)
	 *  
	 * @since 1.0
	 */
	 ...
	 * @since 1.0
	 */
    public JavaTutorialListeners myJavaTutorialListeners = null;
	...
	public boolean doCreateSession(String tutorialTag, String accountName, AppKeyPairMgr myAppKeyPairMgr) {
		...
		myJavaTutorialListeners = new JavaTutorialListeners(this);
	 ...
	 * </ol> 
	 * 
	 * @see JavaTutorialListeners#unRegisterAllListeners()
