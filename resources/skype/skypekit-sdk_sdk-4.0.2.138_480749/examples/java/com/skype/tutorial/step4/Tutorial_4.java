...
package com.skype.tutorial.step4;
...
public class Tutorial_4 { 
	 ...
	 * @since 1.0
	 */
    public static final String MY_CLASS_TAG = "Tutorial_4";
     ...
     * 
     */
    private static Tutorial_4 myTutorial = new Tutorial_4(); 
	...
	public static void main(String[] args) {
		...
		if (mySession.mySignInMgr.Login(MY_CLASS_TAG, mySession, args[ACCOUNT_PWORD_IDX])) {
			myTutorial.doContacts(mySession);
	 ...
	 * @since 1.0
	 */
	void doContacts(MySession mySession) {
       ...
       for (i = 0; i < j; i++) {
           MySession.myConsole.printf("%d. %s%n", (i + 1), myContactList[i].GetStrProperty(Contact.PROPERTY.displayname));
       }
