...
ifeq ($(config),debug-x86)
  ...
  TARGETDIR  = ..
  TARGET     = $(TARGETDIR)/videortphost-loopback
  DEFINES   += -D_DEBUG -DDEBUG
  INCLUDES  += -I../../../../interfaces/videortp -I../../../../interfaces/videortp/videohost_ipc -I../../../../interfaces/skype/cpp_embedded/src/types -I../../../../ipc/cpp/platform/se -I../../../../interfaces/skype/cpp_embedded/src/platform/threading -I../../../../interfaces/skype/cpp_embedded/src/platform/threading/pthread -I../../../../ipc/cpp -I../../../../ipc/cpp/AVTransport
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking videortphost-loopback
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning videortphost-loopback
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/VideoRTPLoopback.o: ../../VideoRTPLoopback.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
