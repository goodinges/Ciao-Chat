...
#ifndef __iMX27RtpInterface_hpp__
#define __iMX27RtpInterface_hpp__
...
struct iMX27RtpInterface : public SkypeVideoRTPInterface, public SendPacketCallback {
public:
	iMX27RtpInterface(SkypeVideoRTPInterfaceCb *callback);
	~iMX27RtpInterface();
