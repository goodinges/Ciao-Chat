...
ifeq ($(config),debug-x86)
  ...
  TARGETDIR  = ..
  TARGET     = $(TARGETDIR)/voicertphost-loopback
  DEFINES   += -D_DEBUG -DDEBUG
  INCLUDES  += -I../../../../interfaces/voicertp -I../../../../interfaces/skype/cpp_embedded/src/types -I../../../../ipc/cpp/platform/se -I../../../../interfaces/skype/cpp_embedded/src/platform/threading -I../../../../interfaces/skype/cpp_embedded/src/platform/threading/pthread -I../../../../ipc/cpp -I../../../../ipc/cpp/AVTransport
...
OBJECTS := \
	$(OBJDIR)/RTPLoopback.o \
	$(OBJDIR)/SidMultiRTPHostMain.o \
	$(OBJDIR)/sidg_msg_multirtpif_cb.o \
	$(OBJDIR)/sidg_multirtpif_cb_client.o \
	$(OBJDIR)/sidg_multirtpif_server.o \
	$(OBJDIR)/sidg_msg_multirtpif.o \
	$(OBJDIR)/SidApi.o \
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking voicertphost-loopback
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning voicertphost-loopback
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/RTPLoopback.o: ../../RTPLoopback.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/SidMultiRTPHostMain.o: ../../../../interfaces/voicertp/SidMultiRTPHostMain.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/sidg_msg_multirtpif_cb.o: ../../../../interfaces/voicertp/sidg_msg_multirtpif_cb.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/sidg_multirtpif_cb_client.o: ../../../../interfaces/voicertp/sidg_multirtpif_cb_client.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/sidg_multirtpif_server.o: ../../../../interfaces/voicertp/sidg_multirtpif_server.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/sidg_msg_multirtpif.o: ../../../../interfaces/voicertp/sidg_msg_multirtpif.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
