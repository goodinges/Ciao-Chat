...
#define TESTIF_DBG_LEVEL 0x200
#define TIMING_DBG_LEVEL 0x400
#define PACKET_DBG_LEVEL 0x800

#undef LOG_MASK

#define LOG_MASK (0xf | TESTIF_DBG_LEVEL)
...
#define TI_DBG(fmt, args...) LOG(TESTIF_DBG_LEVEL, "TestIF:" fmt, ##args)
...
#define TI_FUNCLOG FuncLog __l(__func__, "TI_F:", USE_TIMESTAMPS, LOG_MASK, TESTIF_DBG_LEVEL);
