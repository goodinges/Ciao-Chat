...
/*! \class VideoCapturer
 *  VideoCapturer base class. See V4l2Capturer for reference implementation.
 */
class VideoCapturer
{
public:
...
/*! \class VideoEncoder
 *  VideoEncoder base class. See H264Encoder for reference implementation.
 */
class VideoEncoder
{
public:
...
/*! \class VideoRenderer
 *  VideoRenderer base class. See X11Renderer for reference implementation.
 */
class VideoRenderer
{
public:
...
/*! \class VideoDecoder
 *  VideoDecoder base class. See H264Decoder for reference implementation.
 */
class VideoDecoder 
{
public:
